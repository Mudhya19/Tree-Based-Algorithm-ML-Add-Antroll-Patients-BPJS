    ...
    def execute_query(self, query, params=None):
        ...
        try:
            if self.engine is None:
                self.connect()
            # Ensure the engine is connected before using it
            if self.engine is None:
                raise Exception("Database engine could not be created")
...
# def get_bpjs_antrol_data_for_success_analysis(start_date, end_date):
#     """Get BPJS Antrol patient data specifically for success/failure analysis of registration channels"""
#     query = """
#     SELECT
#         rp.no_rawat,
#         rp.tgl_registrasi,
